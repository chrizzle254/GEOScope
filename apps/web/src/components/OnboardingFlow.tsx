            ...
            <div className="space-y-4 mb-8">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateFormData({ cardNumber: e.target.value.replace(/\D/g, '').slice(0, 16) })
                  }
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.cvv}
                    onChange={(e) =>
                      updateFormData({ cvv: e.target.value.replace(/\D/g, '').slice(0, 3) })
                    }
                    placeholder="123"
                    className="w-full px-6 py-4 border-2 border-[#1e1e1e] rounded text-[20px] tracking-[-0.38px] placeholder:text-[#d9d9d9]"
                    style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 500 }}
        ...
        {step === 6 && (
          <>
            ...
            <p
              ...
              style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 500 }}
            >
              Your 3-day trial starts now. We'll begin tracking {formData.brandName} across all
              major LLMs.
            </p>
            <div className="bg-[#f5f5f5] border-2 border-[#d9d9d9] rounded-lg p-6 mb-8">
              ...
              <ul
                className="space-y-2 text-[#757575] text-[14px]"
                style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 500 }}
              >
