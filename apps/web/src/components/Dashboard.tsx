...
export function Dashboard({ brandData, onSetupComplete }: DashboardProps) {
  ...
  const llmData = [
    {
      name: 'ChatGPT',
      mentions: brandData ? 0 : null,
      prompts: brandData ? 3 : null,
      avgPos: brandData ? 0 : null,
      color: '#10a37f',
    },
    {
      name: 'Claude',
  ...
  if (!brandData) {
    return (
      <>
        ...
        {showOnboarding && <OnboardingFlow onComplete={handleSetupComplete} />}
      </>
    );
  }
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p
              ...
              style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 500 }}
            >
              We're continuously testing prompts across all LLMs. Check back in a few hours for your
              first results. We'll also send you an email when we detect mentions of{' '}
              {brandData?.brandName || 'your brand'}.
            </p>
          </div>
        </div>
