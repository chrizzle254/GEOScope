            ...
            <div key={context.id} className="border-2 border-[#1e1e1e] rounded-lg p-8">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: context.color }} />
                  <p 
                ...
                <div className="flex items-center gap-4">
                  <span className="text-[#757575] text-[14px]" style={{ fontFamily: 'Roboto Mono, monospace' }}>
                    Position #{context.position}
                  </span>
                  <span className={`text-[14px] ${context.sentiment === 'positive' ? 'text-[#10a37f]' : 'text-[#d97757]'}`} style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 700 }}>
