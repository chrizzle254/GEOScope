                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <div className="flex gap-4 text-[12px] text-[#757575]" style={{ fontFamily: 'Roboto Mono, monospace' }}>
        ...
        <div className="border-2 border-[#1e1e1e] rounded-lg p-8">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={llm.name} className="flex items-center justify-between p-6 border-2 border-[#d9d9d9] rounded-lg">
                ...
                <div className="flex items-center gap-6">
                  <span className="text-[#10a37f] text-[14px]" style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 700 }}>
                    Connected
                  </span>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between py-4 border-b border-[#d9d9d9]">
              ...
              <Switch 
                ...
                onCheckedChange={(checked) => setNotifications({...notifications, positionChanges: checked})}
              />
            </div>
            <div className="flex items-center justify-between py-4 border-b border-[#d9d9d9]">
              <div>
            ...
            <div className="flex items-center justify-between py-4">
              ...
              <Switch 
                ...
                onCheckedChange={(checked) => setNotifications({...notifications, competitorUpdates: checked})}
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                style={{ fontFamily: 'Roboto Mono, monospace', fontWeight: 500 }}
              />
              <p className="text-[#757575] text-[12px] mt-2" style={{ fontFamily: 'Roboto Mono, monospace' }}>
