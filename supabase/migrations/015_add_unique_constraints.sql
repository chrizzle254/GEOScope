...
ALTER TABLE public.reporting_subjectcompetitors ADD CONSTRAINT reporting_subject_competitors_reporting_subject_id_name_key UNIQUE (reporting_subject_id, name);
